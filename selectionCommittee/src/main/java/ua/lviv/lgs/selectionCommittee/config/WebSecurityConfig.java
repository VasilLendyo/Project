package ua.lviv.lgs.selectionCommittee.config;
...
import ua.lviv.lgs.selectionCommittee.security.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/registerApplicant").access("hasRole('ROLE_USER')")
		.antMatchers("/submissions").access("hasRole('ROLE_ADMIN')")
